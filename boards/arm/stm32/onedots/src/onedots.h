/****************************************************************************
 * boards/arm/stm32/onedots/src/onedots.h
 *
...
#define GPIO_LED_RED       (GPIO_OUTPUT|GPIO_CNF_OUTPP|GPIO_MODE_10MHz|\
                         GPIO_PORTB|GPIO_PIN5)
#define GPIO_LED_GREEN       (GPIO_OUTPUT|GPIO_CNF_OUTPP|GPIO_MODE_10MHz|\
                         GPIO_PORTB|GPIO_PIN0)
#define GPIO_LED_BLUE       (GPIO_OUTPUT|GPIO_CNF_OUTPP|GPIO_MODE_50MHz|\
                         GPIO_PORTB|GPIO_PIN1)
#define BSI_LED_RED 0
#define BSI_LED_GREEN 1
#define BSI_LED_BLUE 2
#define BSI_LED_ON 1
#define BSI_LED_OFF 0
...
#ifdef CONFIG_ARCH_BOARD_ONTDOTS_STM32F103
