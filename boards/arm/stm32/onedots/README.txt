...
the Olimex USB ARM OCD.  See the script in boards/arm/stm32/onedots/tools/oocd.sh
for more information.  Using the script:

1) Start the OpenOCD GDB server

   cd <nuttx-build-directory>
   boards/arm/stm32/onedots/tools/oocd.sh $PWD
...
============================================
    ...
    CONFIG_ARCH_BOARD - Identifies the boards/ subdirectory and
       ...
       CONFIG_ARCH_BOARD=onedots (for the M3 Wildfire development board)
...
can be selected as follow:
    ...
    tools/configure.sh onedots:<subdir>
